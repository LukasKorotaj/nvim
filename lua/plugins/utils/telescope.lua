return {
  {
    ...
    cmd = 'Telescope',
    keys = {
      { '<leader><space>', function() require('telescope.builtin').find_files() end, desc = 'Find project files' },
      ...
      { '<leader>b', function() require('telescope.builtin').buffers() end, desc = '+buffer' },
      { '<leader>ff', function() require('telescope.builtin').find_files() end, desc = 'Find project files' },
      { '<leader>fr', function() require('telescope.builtin').live_grep() end, desc = 'Find text' },
      { '<leader>fR', function() require('telescope.builtin').resume() end, desc = 'Resume' },
      { '<leader>fg', function() require('telescope.builtin').oldfiles() end, desc = 'Recent' },
      ...
      { '<leader>uC', function() require('telescope.builtin').colorscheme() end, desc = 'Colorscheme preview' },
    },
    config = function()
